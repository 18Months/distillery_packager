defmodule DistilleryPackager.Utils.File do
  @moduledoc """
  ...
  def remove_fs_metadata(data_dir) do
    ...
    |> Enum.each(fn(path) ->
      path
        |> DistilleryPackager.Utils.File.remove_all_files_by_name(".DS_Store")
        |> DistilleryPackager.Utils.File.remove_all_files_by_name("thumbs.db")
    end)
  end
